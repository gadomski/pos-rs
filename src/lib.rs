...
//!
//! These files come in a couple sorts:
//!
//! - `pos`: ASCII format
...
//!
//! This library abstracts these formats out to a common `Point` type, with mandatory position and
//! attitude information and optional accuracy information.
